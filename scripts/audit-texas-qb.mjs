...
for (const game of selected) {
  ...
  for (const play of plays.filter(play => play.gameId === game.id && normal(play.offense) === normal(school) && /passing touchdown|rushing touchdown/.test(String(play.playType ?? "").toLowerCase()))) {
