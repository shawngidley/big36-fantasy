...
export default function Standings() {
  ...
  return <LeagueShell eyebrow="Season standings"><section className="container pt-10 sm:pt-14">
    ...
    <div className="mt-9">
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-2 xl:grid-cols-3">{divisions.map(division => <section key={division.id} className="scoreboard-card p-5">
