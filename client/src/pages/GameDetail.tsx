...
export default function GameDetail() {
  ...
  return <LeagueShell eyebrow="Play-by-play"><section className="container pt-8 sm:pt-12">
    <Link href="/scores" onClick={goBack} className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.13em] text-muted-foreground hover:text-primary"><ArrowLeft className="h-3.5 w-3.5" /> Real scores</Link>
