...
- [ ] Add draft-queue UI, 2025-point regression coverage, and mobile/desktop verification to the owner draft experience.
...
- [ ] Verify the public 36football.com deployment exposes the newly published owner draft board and self-service settings updates after each checkpoint.
