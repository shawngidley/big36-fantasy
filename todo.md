...
- [ ] Select and document the highest-confidence 2025 historical scoring evidence path by component, then update only totals supported by complete reconciliation.
...
- [ ] Evaluate ESPN and public collegiate game-log sources as evidence layers for 2025 DEF event reconstruction, then certify only exact first-12-game control matches.
- [ ] Run a no-cost 2025 DEF and K/ST reconciliation pass using cached ESPN events, collegiate game logs, and official game books before considering commercial historical data.
