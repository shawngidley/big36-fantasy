...
- [ ] Back up the current 36 Football project to GitHub, including the latest published code and research documentation, and verify the repository state.
- [ ] Keep the connected GitHub repository current after every saved 36 Football project checkpoint and confirm the initial repository backup is synchronized now.
