...
- [ ] Configure Twilio-backed SMS delivery and notify the next eligible owner when the owner immediately ahead is placed on the draft clock, with idempotent delivery logging and opt-out-safe contact handling.
