...
describe("36 Football PWA asset wiring", () => {
  it("uses the versioned helmet-only icon assets for the manifest, favicon, and Apple touch icon", () => {
    ...
    expect(manifest).toContain('"src": "/manus-storage/36football-helmet-icon-192_6d7e3e68.png"');
    expect(manifest).toContain('"src": "/manus-storage/36football-helmet-icon-512_53e09209.png"');
    ...
    expect(documentHead).toContain('rel="icon" type="image/png" sizes="192x192" href="/manus-storage/36football-helmet-icon-192_6d7e3e68.png"');
    expect(documentHead).toContain('rel="apple-touch-icon" href="/manus-storage/36football-helmet-icon-192_6d7e3e68.png"');
  });
  ...
  it("keeps the full helmet-and-wordmark asset in the shared public header", () => {
    ...
    expect(leagueShell).toContain('src="/manus-storage/36football-helmet-wordmark-192_f71497b3.png"');
  });
});
