...
The current public [NCAA FBS statistics page](https://www.ncaa.com/stats/football/fbs) also visibly lists **Blocked Kicks**, **Blocked Kicks Allowed**, **Blocked Punts**, and **Blocked Punts Allowed** among team-stat categories. Its rendered landing page does not expose direct static anchors for those categories, however, so it cannot replace the dated-ranking workflow for reproducible first-12-game controls.
